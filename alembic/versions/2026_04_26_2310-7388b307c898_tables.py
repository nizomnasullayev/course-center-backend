...
Revision ID: 7388b307c898
Revises: 
Create Date: 2026-04-26 23:10:50.971966
...
def upgrade() -> None:
    ...
    op.create_table('course_centers',
    ...
    op.create_index(op.f('ix_course_centers_id'), 'course_centers', ['id'], unique=False)
    op.create_table('subjects',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('name', sa.String(length=255), nullable=False),
    sa.Column('course_center_id', sa.UUID(), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['course_center_id'], ['course_centers.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('course_center_id', sa.UUID(), nullable=True),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_course_centers_id'), table_name='course_centers')
